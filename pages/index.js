...
export default function Home() {
    return (
        // <div className="space-x-3">Tailwind CSS</div>;
        // <div className="mx-8 py-4 grid grid-cols-3 gap-10">
        <>
            <Hero>
                <Hero.Body>
            ...
            <div className="container">
                <div className="w-1/2">
                    ...
                    <article className="text-lg leading-relaxed">
                        <p className="mb-10">
                            Lorem ipsum, dolor sit amet consectetur adipisicing
                            elit. Nemo, voluptatem.Lorem ipsum, dolor sit amet
                            consectetur adipisicing elit. Nemo, voluptatem.
                        </p>
                        <p>
                            Eum sint voluptate debitis dignissimos. Aliquid
                            molestias vel voluptatibus tempora!Lorem ipsum,
                            dolor sit amet consectetur adipisicing elit. Nemo,
                            voluptatem.Lorem ipsum, dolor sit amet consectetur
                            adipisicing elit. Nemo, voluptatem.
                        </p>
                    </article>
                </div>
            </div>
